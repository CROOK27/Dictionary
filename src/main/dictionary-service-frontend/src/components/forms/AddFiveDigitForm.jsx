...
const AddFiveDigitForm = ({ onSuccess }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      setLoading(true);
      await fiveDigitService.create({ word, description });
  ...
  return (
    <Card>
      <Card.Header>
        <h5 className="mb-0">Добавить в 5-значный словарь</h5>
      </Card.Header>
      <Card.Body>
        <Form onSubmit={handleSubmit}>
          <Form.Group className="mb-3">
            <Form.Label>Слово (5 знаков)</Form.Label>
            <Form.Control
              type="text"
              value={word}
...
export default AddFiveDigitForm;